...
//   }
  ...
  {
    if(values[2] == '1') document.getElementById('switch1').checked=true ;
    else document.getElementById('switch1').checked=false ;
    if(values[3] == '1') document.getElementById('switch2').checked=true ;
    else document.getElementById('switch2').checked=false ;

    if(values[5] == '1') document.getElementById('switch3').checked=true ;
    else document.getElementById('switch3').checked=false ;
    if(values[6] == '1') document.getElementById('switch4').checked=true ;
    else document.getElementById('switch4').checked=false ;

    if(values[8] == '1') document.getElementById('switch5').checked=true ;
    else document.getElementById('switch5').checked=false ;
    if(values[9] == '1') document.getElementById('switch6').checked=true ;
